...
const Card = () => {
  return (
    <div className="relative flex flex-col items-center text-[8px] sm:text-base ">
      <div className="absolute -right-2 -top-2 flex h-8 w-8 scale-[0.4] cursor-pointer items-center justify-center  rounded-full border border-primary-light bg-[#1a1a1a] xs:right-0 xs:top-0 xs:scale-[0.7] sm:right-2 sm:top-2 sm:scale-[1] ">
        <PlayIcon />
      </div>
